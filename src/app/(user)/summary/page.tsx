        ...
        <Card className="w-full max-w-md shadow-lg border-0 overflow-hidden">
          <div className="p-6 bg-white rounded-t-lg">
            <div className="flex flex-col items-center justify-center mb-6 text-center">
              <div className="w-16 h-16 rounded-full bg-[#FFB8DA]/10 flex items-center justify-center mb-4">
                <FaRegHourglass className="w-8 h-8 text-[#FFB8DA]" />
              </div>
              <h2 className="text-2xl font-bold text-[#4D4D4D] mb-2">อยู่ระหว่างการตรวจสอบ</h2>
              <p className="text-gray-500 max-w-xs">
                การจองนี้ยังอยู่ในขั้นตอนการตรวจสอบ หากการจองของคุณได้รับการยืนยัน เราจะแจ้งให้คุณทราบอีกครั้ง
              </p>
            </div>
